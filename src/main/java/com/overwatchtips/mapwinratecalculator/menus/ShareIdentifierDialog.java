...
public class ShareIdentifierDialog extends JDialog {
    ...
    private void onOK() {
        try {
            this.calculateMaps(this.textField.getText(), textArea.getText());
        } catch (IOException e) {
    ...
    public void calculateMaps(String shareId, String accounts) throws IOException {
        List<String> asList;
        if (accounts.isEmpty()) {
        ...
        data.games().forEach(match -> {
            ...
            if (asList.isEmpty() || asList.contains(match.playerName().toLowerCase())) {
